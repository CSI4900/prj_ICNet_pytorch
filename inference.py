...
class Evaluator(object):
    ...
    def eval(self):
        ...
        for i in range(len(self.image_paths)):
            ...
            image = image.resize((2048, 1024), Image.BILINEAR) # Resize to (2048x1024)
            ...
            logger.info("Sample: {:d}, time: {:.3f}s".format(
                i + 1, step_time))
            ...
            pred.save(os.path.join(outdir, prefix + "_test.png"))
        ...
        logger.info("Average time: {:.3f}".format(average_time))
